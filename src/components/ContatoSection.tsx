...
export default function ContatoSection() {
  ...
  const displayPhone = "(14) 99104-2262";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        [background-image:linear-gradient(to_right,rgba(0,0,0,.25)_1px,transparent_1px),
        linear-gradient(to_bottom,rgba(0,0,0,.25)_1px,transparent_1px)]
      ...
      >
        <h2
          id="contato-heading"
          className={`${display.className} text-3xl md:text-5xl leading-tight mb-4`}
        >
      ...
      >
        ...
        >
          <span
            className="absolute -inset-[1px] -z-10 rounded-2xl opacity-0 blur-md transition duration-300 group-hover:opacity-100"
        ...
        <motion.a
          ...
          className="group relative flex flex-col items-center justify-center rounded-2xl p-6 shadow-xl transition hover:shadow-2xl focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-900/10"
          style={{
            background: "linear-gradient(90deg,#E9D8A6,#C8B273)",
            border: "1px solid #C8B273",
          }}
        >
          <MessageSquare
            size={28}
            className="text-slate-900 transition group-hover:scale-110"
          />
          <span
            className={`${display.className} mt-2 text-xl font-bold uppercase text-slate-900`}
          >
            Começar agora
          </span>
